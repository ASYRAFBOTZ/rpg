                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? '🕹MENU MARK BOTZ🕹' : '🎉BYE YATIM🎉', action === 'add' ? '.menu' : 'FokusID')
                        }
                    }
                }
                break
